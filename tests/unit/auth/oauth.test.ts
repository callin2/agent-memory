...
describe('OAuth Service', () => {
  ...
  describe('getAuthorizationUrl', () => {
    ...
    it('should throw error for non-existent provider', async () => {
      ...
      await expect(
        oauthService.getAuthorizationUrl('nonexistent', 'http://localhost:3000/callback', 'state')
  ...
  describe('createOAuthConnection', () => {
    ...
    it('should create OAuth connection without tokens', async () => {
      ...
      await oauthService.createOAuthConnection('user_123', 'google', 'google_user_123');
